...
data class LightColorPalette @JvmOverloads constructor(
    ...
    val errorTextColor: String = "#FFB34351",
    ...
    val inputFieldSelectedBorderColor: String = "#FF003F33",
    val inputElementActiveTintColor: String = "#FF003F33",
...
data class DarkColorPalette @JvmOverloads constructor(
    ...
    val separatorColor: String = "#33000000",
    val errorTextColor: String = "#FFFF8066",
    ...
    val inputFieldSelectedBorderColor: String = "#FF3CEAC7",
    val inputElementActiveTintColor: String = "#FF3CEAC7",
